package com.demo.skeleton.skeleton

import android.content.Context
import androidx.annotation.ColorInt
import androidx.annotation.ColorRes
import androidx.annotation.Px
import com.demo.skeleton.annotation.BuilderMarker
import com.demo.skeleton.util.getColorCompat
import com.demo.skeleton.util.self
...
open class SkeletonBuilder<T : SkeletonBuilder<T>> {
    ...
    @JvmField
    @Px
    protected var cornerRadius: Float?
    @JvmField
    @ColorInt
    protected var color: Int?
    @JvmField
    protected var isShimmerEnabled: Boolean?
    @JvmField
    protected var shimmer: Shimmer?
    @JvmField
    @Px
    protected var lineSpacing: Float?
