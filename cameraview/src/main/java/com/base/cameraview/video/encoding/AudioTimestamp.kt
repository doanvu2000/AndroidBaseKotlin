 ...
 */
internal class AudioTimestamp(private val mByteRate: Int) {
    ...
    fun increaseUs(readBytes: Int): Long {
        val bufferDurationUs: Long = bytesToUs(readBytes.toLong(), mByteRate)
        ...
        val correctedTimeUs: Long = mBaseTimeUs + bytesToUs(mBytesSinceBaseTime, mByteRate)
...
//            }
    ...
    fun getGapCount(frameBytes: Int): Int {
        ...
        val durationUs: Long = bytesToUs(frameBytes.toLong(), mByteRate)
