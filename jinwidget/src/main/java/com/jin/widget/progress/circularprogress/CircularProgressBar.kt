package com.jin.widget.progress.circularprogress
...
import com.jin.widget.utils.dpToPxF
import kotlin.math.min

/**
 * A circular progress bar view for Android, fully customizable in code or via XML.
 *
 * This view allows for the display of progress in a circular fashion, offering extensive
 * customization options for its appearance and behavior.
 *
 * Main features include:
 * - **Customizable Colors:** Set solid or gradient colors for both the progress bar and its background.
 * - **Adjustable Stroke:** Control the width of the progress and background lines.
 * - **Rounded Edges:** Option to have rounded ends for the progress bar.
 * - **Animation:** Animate progress changes with customizable duration and interpolator.
 * - **Indeterminate Mode:** A continuous loading animation for when progress is unknown.
 * - **Control Start Angle and Direction:** Define where the progress starts and whether it fills clockwise or counter-clockwise.
 *
 * Example usage in XML:
 * ```xml
 * <com.jin.widget.progress.circularprogress.CircularProgressBar
...
class CircularProgressBar(
    ...
    companion object {
        ...
        private const val DEFAULT_START_ANGLE = 360f
    ...
    var progressBarWidth: Float = 7.dpToPxF
        set(value) {
            field = value.dpToPx()
    ...
    var backgroundProgressBarWidth: Float = 3.dpToPxF
        set(value) {
            field = value.dpToPx()
    ...
    private fun Int.toProgressDirection(): ProgressDirection = when (this) {
        ...
        else -> throw kotlin.IllegalArgumentException("This value is not supported for ProgressDirection: $this")
    }
    ...
    private fun Int.toGradientDirection(): GradientDirection = when (this) {
        ...
        else -> throw kotlin.IllegalArgumentException("This value is not supported for GradientDirection: $this")
    }
    //endregion
