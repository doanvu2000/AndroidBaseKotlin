...
//                }
                ...
                if (a.hasValue(R.styleable.MagicTextView_strokeColorMg)) {
                    float strokeWidth = a.getDimensionPixelSize(R.styleable.MagicTextView_strokeWidthMg, 1);
                    int strokeColor = a.getColor(R.styleable.MagicTextView_strokeColorMg, 0xff000000);
                    float strokeMiter = a.getDimensionPixelSize(R.styleable.MagicTextView_strokeMiterMg, 10);
                    Join strokeJoin = switch (a.getInt(R.styleable.MagicTextView_strokeJoinStyle, 0)) {
                        case (0) -> Join.MITER;
                        case (1) -> Join.BEVEL;
                        case (2) -> Join.ROUND;
                        default -> null;
    ...
    private void generateTempCanvas() {
        String key = String.format(Locale.ENGLISH, "%dx%d", getWidth(), getHeight());
